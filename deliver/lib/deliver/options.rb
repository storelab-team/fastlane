    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :price_tier,
                                     ...
                                     type: Integer,
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :base_territory,
                                     env_name: "DELIVER_BASE_TERRITORY",
                                     description: "The base territory for pricing (e.g. USA, GBR, JPN). Defaults to USA",
                                     optional: true,
                                     default_value: "USA"),
        FastlaneCore::ConfigItem.new(key: :available_countries,
                                     env_name: "DELIVER_AVAILABLE_COUNTRIES",
                                     description: "A list of territory codes where the app should be available (e.g. ['USA', 'GBR']). " \
                                                  "If not provided, availability is not changed unless available_in_new_territories is set",
                                     optional: true,
                                     type: Array),
        FastlaneCore::ConfigItem.new(key: :available_in_new_territories,
                                     env_name: "DELIVER_AVAILABLE_IN_NEW_TERRITORIES",
                                     description: "Whether the app should automatically become available in new App Store territories",
                                     optional: true,
                                     type: Boolean),
